...
define('_MI_TINYCONTENT_DESC', 'Den nemmeste måde at lave indhold.');

// Name for Menu Block
define('_MI_TC_BNAME1', 'Tiny Content Menu');

// Admin Menu
define('_TC_MD_ADMENU1', 'Tilføj indhold');
define('_TC_MD_ADMENU2', 'Tilføj ekstern side');
define('_TC_MD_ADMENU3', 'Redigér/Slet Indhold');
