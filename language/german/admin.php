...
define('_TC_RUSUREDEL', 'Diesen Content wirklich löschen?');
define('_TC_RUSUREDELF', 'Diese Datei wirklich löschen?');
define('_TC_UPLOADED', 'Datei erfolgreich hochgeladen!');
define('_TC_FDELETED', 'Datei erfolgreich gelöscht!');
