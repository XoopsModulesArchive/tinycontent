...
class SPAW_TB_Item
{
    ...
    public function __construct($name, $lang, $editor, $theme, $attributes = '', $data = '')
    {
        $this->name = $name;
...
class SPAW_Toolbars
{
    ...
    public function __construct($lang, $editor, $mode = '', $theme = '', $dropdown_data = '')
    {
    ...
    public function get($pos, $mode = 'design')
    {
    ...
    public function getTbItem($name, $type, $attributes, $data)
    {
        switch ($type) {
      case SPAW_TBI_IMAGE:
